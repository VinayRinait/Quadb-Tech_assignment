    ...
    <Box p={14} backgroundColor="#f5f5f5" borderRadius="lg" boxShadow="md">
        ...
        >
          <Box flex={1} pr={[0, 0, 6]}>
            <Flex placeItems={"center"} gap={5} flexWrap={"wrap"}>
              ...
              <Badge color="white" bg="#002A53" fontSize="lg" borderRadius={"3px"}>
            ...
            <Flex alignItems="center" mt={8} gap={5} flexWrap={"wrap"}>
              <Button color="white" bg="#002A53" onClick={handleApplyClick}>
                Apply Now
              </Button>
              <Button color="white" bg="#002A53" onClick={() => window.history.back()}>
                Back
              </Button>
            </Flex>
          </Box>
      ...
      <Modal isOpen={isApplying} onClose={handleCloseModal}>
        ...
        <ModalContent>
          ...
          <ModalFooter>
            <Button color="white" bg="#002A53" mr={3} onClick={handleFormSubmit}>
              Submit
            </Button>
